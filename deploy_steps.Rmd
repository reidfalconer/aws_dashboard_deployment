...
You should now minimize your browser window and fire up your command line - on a Mac, it's your Terminal (if you run on Windows, you'll need to download [PuTTY](https://www.putty.org/).). Then the first thing you want to do is to change your directory (cd) to where your key (`.pem` file) was securly moved to (i.e out of your download folder).
